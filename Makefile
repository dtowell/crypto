...
all: rand xor en64 de64 dekey enaesecb deaesecb enaescbc deaescbc sha tests torture
...
clean:
	rm -f *.o rand rand2 xor en64 de64 dekey enaesecb deaesecb enaescbc deaescbc sha tests t2 t3 h2 h3 hex torture
